...
def handler(remote_controller_msg):
    ...
    """
    if remote_controller_msg.a == 1 and remote_controller_msg.b == 1 and K1_chair_state == 0:
        #chair sit-down command
        K1_chair_state = 1
        pass
    elif remote_controller_msg.rb == 1 and remote_controller_msg.rt == 1 and K1_chair_state == 1:
        #chair get-up command
        K1_chair_state = 0
        pass
    elif remote_controller_msg.lb == 1 and remote_controller_msg.lt == 1:
        #Ai chat(maybe?)
